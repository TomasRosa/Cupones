...
export class InicioComponent implements AfterViewInit{
  ...
  ngAfterViewInit() {
    ...
    {
      const carouselInstance = this.myCarousel.nativeElement as HTMLElement;
      carouselInstance.addEventListener('slid.bs.carousel', (event: Event) => 
      {
        this.actualizarParrafoDesdeCarousel(event);
      });
    }
  }
  
  destacados: any[] = [{nombre: 'Cine Espacio Inca',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-cine/espacio-incaa.jpeg',precio:'$500'},
  {nombre: 'Foot-Golf Tandil',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-entretenimiento/foot-golf-tandil.jpg',precio:'$500'},
  {nombre: 'Estetica Ana Paula',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-estetica/estetica-ana-paula.JPG',precio:'$500'},
  {nombre: 'Restaurante La Cuadra',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-gastronomia/la-cuadra-tandil.jpg',precio:'$500'},
  {nombre: 'Concesionaria San Jorge',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-vehiculos/san-jorge-consecionarias.jpg',precio:'$500'},
  {nombre: 'Hotel Nuevos Horizontes',descripcion:'Lorem ipsum, dolor sit amet consectetur',imagen:'assets/images/images-escapadas/hotel-nuevos-horizontes.webp',precio:'$500'}]

  public actualizarParrafoDesdeCarousel(event: Event) {
    const targetElement = event.target as HTMLElement;
    const activeElement = targetElement.querySelector('.carousel-item.active');
    
    if (activeElement !== null) 
    {
      console.log('Active element isnt null. ');
      const indexAsNumber = activeElement.getAttribute('data-slide-to');
      
      if (indexAsNumber !== null) 
      {
        this.parrafoActual = this.imagenes[+indexAsNumber].parrafo;
        this.nombreActual = this.imagenes[+indexAsNumber].nombre;
      }
    }
    else
    {
      console.log('Active element is null. ');
    }
  }
